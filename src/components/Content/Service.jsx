const Service = ({service}) => {
    ...
    return (
        <div className={`bg-black/60 bg-blend-multiply bg-[url(${service.bgImage})] bg-cover bg-center bg-no-repeat pt-[147px] pb-[139px] pl-5 md:pl-[116px] pr-5 md:pr-0 text-center md:text-left`}>
