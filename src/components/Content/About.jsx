    ...
    return (
        <div>
            <div className='bg-[#F0F0F0] py-[136px]'>
                <Container>
                    <div className='flex'>
                            <h3 className="bg-primary blogh font-primary font-bold text-4xl w-[385px] text-white pt-[100px] flex items-center pb-[99px] pl-[74px] pr-[77px] leading-12">Learn more about our company</h3>
