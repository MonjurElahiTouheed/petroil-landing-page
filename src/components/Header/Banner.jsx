...
const Banner = () => {
    return (
        <div className="bg-[url(assets/banner.png)] py-[258px] bg-black/60 bg-blend-multiply">
            ...
            <button className="bg-primary hover:bg-red-800 hover:text-white/90 px-[41px] mt-[31px] py-3.5 text-white font-primary font-semibold text-base duration-150">LEARN MORE</button>
            </Container>
        </div>
    );
};
