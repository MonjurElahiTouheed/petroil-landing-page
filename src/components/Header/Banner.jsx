...
const Banner = () => {
    return (
        <div className="text-center lg:text-left bg-[url(assets/banner.png)] bg-cover bg-[-32rem] sm:bg-center bg-no-repeat py-32 lg:py-[258px] bg-black/60 bg-blend-multiply">
            <Container>
